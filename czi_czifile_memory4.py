...
<OME xmlns="http://www.openmicroscopy.org/Schemas/OME/2016-06"    
    ...
    <Image Name="image" ID="urn:lsid:loci.wisc.edu:Image:ows427"
            DefaultPixels="urn:lsid:loci.wisc.edu:Pixels:ows427">
        <CreationDate>2021-09-07T12:29:37</CreationDate>
        <ExperimenterRef ID="urn:lsid:loci.wisc.edu:Experimenter:2"/>        
        <Pixels ID="urn:lsid:loci.wisc.edu:Pixels:ows427"
                Type="Uint8"
                DimensionOrder="TZXYC"
                SizeX="{image_width}" 
                SizeY="{image_height}" 
                SizeZ="7" 
                SizeC="{image_bands}" 
...
filename = filepath_sample2 + '26ROI' + '.ome.tif' #.tiff, ome.tif
im.tiffsave(filename, compression="jp2k", tile=True,
